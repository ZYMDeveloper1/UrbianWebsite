...
import TechTop from '../components/technologyassesstmenttop'
import Louisbester from '../assets/images/Louis-bester.jpg'
import Stephangrobler from '../assets/images/Stephan-grobler.jpg'
import { Helmet } from 'react-helmet'
class customervalue extends React.Component {
  render() {
    return (
      <div className="experienceurbianpage grass">
        <Layout>
          <Helmet>
            <title>Urbian | Technology assessment</title>
          </Helmet>
          <TechTop></TechTop>
