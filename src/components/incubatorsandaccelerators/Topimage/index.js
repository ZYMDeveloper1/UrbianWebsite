    ...
    return (
      <Container className="scontent-wrap introduction">
        ...
        <Row>
          <Col md="12">
            <figure>
              <img src={Bannerimg} className="img-fluid" alt="Possibly some text here to not make this feel like a stock photo" />
              <figcaption>
        ...
        <Row className="spb-10 border-bottom">
          <Col className="testimonial">
            ...
            <span>Yves Henri Donat Mathieu-Saint-Laurent, CEO of Met-S Care</span>
          </Col>
        </Row>
      </Container>
    )
