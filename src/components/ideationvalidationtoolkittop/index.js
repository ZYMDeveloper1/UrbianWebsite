...
class buyvsbuildtop extends React.Component {
  render() {
    return (
      <div className="introduction-container sp-5 scontent-wrap">
        <Container>
          <Row className="align-items-center">
            <Col lg="6">
              ...
              <h1>Ideation validation toolkit</h1>
              <p className="intro">
            ...
            <Col lg="6" className="hidden-on-mobile-and-tablet">
