            ...
            <div className="col-md-10 offset-md-1">
              <div className="row align-items-center">
                <Col md="6">
                  ...
                  <h3>Skillshift</h3>
                  <p>
                    Skillshift takes the hassle out of finding and managing
                    skilled shift workers throught and on-demand marketplace.
                  </p>{' '}
                  <strong>What we did:</strong>
                  <p>
                    Content &amp; Video, Rapid Prototyping, Branding, UX/UI
            ...
            <div class="col-md-10 offset-md-1">
              <div class="row align-items-center">
                <Col md="6">
                  ...
                  <p>
                    Balltalent is a soccer talent discovery tool helping scouts
                    find africa's future soccer star.
                  </p>{' '}
                  <strong>What we did:</strong>
                  <p>
                    Content &amp; Video, Rapid Prototyping, Branding, UX/UI
            ...
            <div className="col-md-10 offset-md-1">
              <div className="row align-items-center">
                ...
                <Col md="6" className="offset-lg-2">
                  ...
                  <p>
                    Jonga provides community-based security to low-income
                    families.
                  </p>{' '}
                  <strong>What we did:</strong>
                  <p>
            ...
            <div class="col-md-10 offset-md-1">
              <div class="row align-items-center">
                <Col md="6">
                  ...
                  <p>
                    Ispani provides micro-jobbing for emerging markets through
