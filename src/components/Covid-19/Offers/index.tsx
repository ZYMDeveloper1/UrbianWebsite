...
class Offers extends React.Component {
  render() {
    return (
      <div className="offers_min">
        <div className="skyblue-bg what-donext">
          <Container>
            <h2 className="text-center">What to do next.</h2>
            <div className="mt-5">
            ...
            <Row className="border-bt sp-2">
              ...
              <Col lg="3" className="vhcenter">
                <Link
                  className="fbutton styled__Link-lfEBUk iUBhrC font-bold red"
                  to="#"
                >
                  <b>View offering</b>
                  <svg
        ...
        <Container className="spt-8" id="offering-one">
          <Row>
            <Col lg="6">
              <h5 className="servicetext">
                We have put together a suit of services aimed at{' '}
                <u className="red">ensuring business continuity</u> for
          ...
          <Row className="casestudy-single align-items-center spt-10">
            <Col lg="7">
              <img
                className="img-fluid"
                src={Casestudies1}
                alt="Remote project delivery for Standard Bank Direct"
              />
            </Col>
            <Col lg="5">
              ...
              <p>
                ...
                being delivered by <a> remote teams.</a>
              </p>
              <Link
          ...
          <Row className="covidinnovationtop spb-8">
            <Col lg="6">
              <div class="sp-5">
                <span class="timebox"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 172.92 173.01" width="18px"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" fill="#4a0053" data-name="Layer 1"><path d="M0,86.46C0,39.15,39.06,0,86.46,0s86.46,39.15,86.46,86.46S133.86,173,86.46,173,0,133.86,0,86.46Zm160.5,0a74,74,0,1,0-74,74A73.93,73.93,0,0,0,160.5,86.46ZM35.44,90a5.1,5.1,0,0,1,5.16-5.16H81.29v-54a5.17,5.17,0,0,1,10.33,0V90a5.11,5.11,0,0,1-5.16,5.17H40.6A5.11,5.11,0,0,1,35.44,90Z"></path></g></g></svg><span>1 hour</span></span>
                ...
                <ul class="emp">
                  ...
                  <li>
                    ...
                    <span>Learn over Lunchtime</span>
                  </li>
                  <li>
                    <svg
                      width="25px"
          ...
          <div className="testimonial">
            ...
            <span>
              Reginald, Head of Special Project <br /> Sanlam Private Wealth
            </span>
          </div>
        </Container>
        <div className="Two-div spb-8">
          <Container id="offering-two">
            <Row>
              <Col lg="3">
                <h1 className="emp red">Two</h1>
              </Col>
              <Col lg="9">
                <Row className="sp-4">
                  <Col lg="8">
            ...
            <Row className="casestudy-single spb-10 align-items-center">
              <Col lg="7">
                <img
                  className="img-fluid"
                  src={bablytonstoren}
                  alt="Bablytonstoren' Custom E-Commerce Implementation increased sales by 150% in under 6 months."
                />
              </Col>
              <Col lg="5">
                <span class="type">Case Study</span>
                <h3>
                  Babylonstoren' Custom E-Commerce Implementation increased
